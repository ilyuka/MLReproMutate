...
successful execution of an existing validation workflow often did not constrain
the particular reproducibility-relevant choice that had been mutated.

The study also highlights executability as a practical prerequisite for
retrospective mutation analysis. A substantial fraction of frozen cases could
not initially reach mutation evaluation, and bounded restoration recovered
additional evidence without rewriting the primary execution record.
