...
workflows detected only 2 of 23 confirmed non-equivalent
...
sensitivity}: for a substantial fraction of the evaluated cases in this
sample, the selected existing workflow did not distinguish the original
configuration from a controlled, semantically different one.
...
A second major observation concerns executability. Only 13 of the 39 frozen
