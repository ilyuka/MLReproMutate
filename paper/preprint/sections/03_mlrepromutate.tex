...
MLReproMutate is a Python research-software tool for applying controlled
mutations to reproducibility-relevant choices in machine-learning research
software and evaluating whether an existing repository validation workflow
detects the resulting change.
